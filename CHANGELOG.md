...
- Added backup & restore: export saved servers and their logins to a file (via the share sheet), and import a previously exported file to restore them or move them to another device. Accessible from the icon in the top-right of the server list.
